...
public abstract class AliasedCertCommand extends BaseCommand {
    ...
    public CommandResult execute(Object[] params) {
        ...
        try {
            ...
            if (certFx instanceof AliasedCertificateFactory) {
                return execute((BaseCertificateFactory) certFx, params);
            }
    ...
    protected abstract CommandResult execute(BaseCertificateFactory certFx, Object[] params) throws OpenAS2Exception;
